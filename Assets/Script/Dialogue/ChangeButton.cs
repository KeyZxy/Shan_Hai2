...
public class ChangeButton : MonoBehaviour
{
    ...
    private void UpdateButtonSelection()
    {
        for (int i = 0; i < buttons.Length; i++)
        {
            ...
            {
                // 有选中的按钮时更改状态  
                buttons[i].GetComponentInChildren<Text>().color = new Color(37f / 255f, 37f / 255f, 37f / 255f); 
            ...
            {
                // 没有选中的按钮时保持默认状态  
                buttons[i].GetComponentInChildren<Text>().color = new Color(198f/255f,198f/255f,198f/255f); 
